...
| U-5 | **Bug autocomplete : Entrée ferme la liste** — appuyer sur Entrée pour lancer le calcul laisse la dropdown ouverte ; elle doit se fermer avant le calcul | Bug UX, correctif simple |
