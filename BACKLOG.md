...
| U-7 | ✅ | ~~**Mode conduite**~~ — bottom panel avec les 4 prochaines stations (tri par distance GPS), bouton ⬆ Conduire dans la barre d'actions, mise à jour à chaque fix GPS, carte "Signal GPS perdu" si géoloc absente | ✅ feat/U2-station-results-list |
